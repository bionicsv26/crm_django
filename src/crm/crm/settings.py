...
INSTALLED_APPS = [
    ...
    'crm.products.apps.ProductsConfig',
...
LOGOUT_URL = reverse_lazy('crm.users:index')

LOGIN_REDIRECT_URL = reverse_lazy('crm.users:index')

LOGOUT_REDIRECT_URL = reverse_lazy('crm.users:index')
